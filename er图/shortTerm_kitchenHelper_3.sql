...
alter table orderDetail add constraint FK_Reference_14 foreign key (foodNo)
      references foodInfo (foodNo) on delete restrict on update restrict;
...
alter table recipeStep add constraint FK_Reference_13 foreign key (foodNo)
      references foodInfo (foodNo) on delete restrict on update restrict;
...
alter table recipeUse add constraint FK_Reference_12 foreign key (recipeNo)
      references recipeInfo (recipeNo) on delete restrict on update restrict;
